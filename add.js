...
let member = ["sana", "muntaha", "javeria", "shazia"];
for (let i = 0; i < member.length; i++) {
    console.log(member[i]);
}
//project question12
//Guest List: If you could invite anyone, living or deceased, to dinner, who would you invite?
let members = ["sana", "muntaha", "javeria", "shazia"];
let messag = 'kl birthday kis ki hai';
for (let i = 0; i < members.length; i++) {
    console.log(message + members[i]);
}
//Question # 11
//Think of your favorite mode of transportation
let transporation = ["car", "bike", "cycle", "bus", "auto", "greeline bus", "suzuki"];
...
//project question16
//start//
let guest_list = ["sidra", "amna", "rabiya"];
export { guest_list };
for (let i = 0; i < guest_list.length; i++) {
    console.log("respected madam" + guest_list[i] + `,\nwe invited you on dinner tomorrow.\nThank you\n`);
}
let not_peresent = 'sidra';
let new_gueste = 'sheeza';
for (let i = 0; i < guest_list.length; i++) {
    console.log('respected madam' + guest_list[i] + `,\n we invited you on dinner tomorrow.\nThank you\n`);
}
...
let places = ['cape town', 'dehli', 'faislabad', 'bankok', 'ahmadabad'];
...
//QUESTION #20
let languages = ["english", "urdu", "arabic", "franch", "chines", "turkey",];
...
let array = ['ramsha', 'rumaisa', 'tuba', 'arooba', 3, 5, 8, 'sana',];
console.log(array[1]);
console.log(array[0]);
console.log(array[2]);
console.log(array[4]);
...
//QUESTIONS # 29
let favorite_fruits = ['apple', 'mango', 'banana', 'straberry', 'grapes'];
...
//QUESTIONS # 30
let users = ['sana', 'javeria', 'munataha', 'seerat', 'fatima'];
...
//QUESTION # 31
let user = ['sana', 'muntaha', 'javeria', 'fatima', 'seerat',];
if (user.length === 0) {
...
//QUESTIONS# 32
let current_users = ['sualeha', 'tuba', 'ramsha', 'sana', 'amna',];
let new_users = ['rabiya', 'hafsa', 'soniya', 'sajjal', 'sana'];
...
console.log(`\nI really like to eat pizzas.pizza comes in a varisty of flavors and tooping, allowing individuals to customiz`);
function make_shiirt(size, massage) {
...
console.log(album6);
//QUESTIONS# 41
let magicians = ['bard', 'rameez', 'ainak wala',];
...
//4QUESTIONS # 42
let magicianss = ['don', 'rameez', 'chris',];
...
//question 43
let magiciansss = ['alice', 'david', 'chris'];
